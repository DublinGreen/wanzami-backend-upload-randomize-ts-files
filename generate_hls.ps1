...
ffmpeg -i "$INPUT" \
  ...
  -map [v1out] -c:v:0 libx264 -b:v:0 5000k -maxrate:v:0 45350k -bufsize:v:0 7500k -preset veryfast -g 48 -sc_threshold 0 \
  ...
  -map a:0 -c:a:0 aac -b:a:0 320k \
  -map a:0 -c:a:1 aac -b:a:1 320k \
  -map a:0 -c:a:2 aac -b:a:2 320k \
